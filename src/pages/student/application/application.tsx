...
import {imgMap, colorMap} from "@/configs/applicationConfig";
        ...
        <View className='task-wrap'>
          <TaskELem>
            ...
            <View className='task-button-wrap task-special'>
              <Button className='task-short-button'>提交</Button>
              <Button className='task-short-button'>申请</Button>
            </View>
          </TaskELem>
          <TaskELem>
            <View className='task-desc'>培养单位意见</View>
            <View className='task-button-wrap'>
              <Button className='task-long-button'>查看</Button>
            </View>
          </TaskELem>
          <TaskELem>
