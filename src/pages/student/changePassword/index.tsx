...
import { studentPasswordConfig } from '@/configs/detailedInfoConfig';
...
const DetailedInfoPage: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <DetailedInfo {...studentPasswordConfig} data={{'currentAcc': currenInfo?.student_id}} text={`${currenInfo?.name}同学您好\n为了保障您的账户安全，请您在首次登陆使修改账号及密码`}></DetailedInfo>
      </PageWrap>
    </>
  );
};
